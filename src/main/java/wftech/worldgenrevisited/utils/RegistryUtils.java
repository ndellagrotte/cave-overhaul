package wftech.worldgenrevisited.utils;
...
import wftech.worldgenrevisited.mixins.VanillaRegistriesAccessor;
			...
			*/
			...
			try (Reader reader = resource.openAsReader()) {
				...
				*/
				...
				WorldgenRevisited.LOGGER.error("RegistryUtils Major error! " + exception);
				StackTraceElement[] stack = exception.getStackTrace();
				for(StackTraceElement el: stack) {
					WorldgenRevisited.LOGGER.error("[WorldgenRevisited] -> RegistryUtils " + el);
				}
