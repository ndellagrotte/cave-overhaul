...
import wftech.worldgenrevisited.carvertypes.rivers.*;
import wftech.worldgenrevisited.carvertypes.simplex.NoiseCaveSimplexBoring;
...
public class InitCarverTypes {
	...
	public static final DeferredRegister<WorldCarver<?>> WORLD_CARVERS =
            DeferredRegister.create(ForgeRegistries.WORLD_CARVERS, WorldgenRevisited.MOD_ID);
