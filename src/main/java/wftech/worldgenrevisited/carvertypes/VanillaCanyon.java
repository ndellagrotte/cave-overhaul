...
public class VanillaCanyon extends CanyonWorldCarver {
	...
	public boolean carve(CarvingContext p_224813_, 
		...
		return super.carve(p_224813_, p_224814_, chunkAccess, p_224816_, p_224817_, new AirOnlyAquifer(chunkAccess, p_224817_.nextFloat() <= Config.PERC_PIERCE_SURFACE_CANYON.get()), p_224819_, p_224820_);
	}
}
