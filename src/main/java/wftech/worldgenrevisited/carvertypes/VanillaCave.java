...
public class VanillaCave extends CaveWorldCarver {
	...
	public boolean carve(
		...
		return super.carve(p_224885_, p_224886_, chunkAccess, p_224888_, p_224889_, new AirOnlyAquifer(chunkAccess, p_224889_.nextFloat() <= Config.PERC_PIERCE_SURFACE.get()), p_224891_, p_224892_);
	}
