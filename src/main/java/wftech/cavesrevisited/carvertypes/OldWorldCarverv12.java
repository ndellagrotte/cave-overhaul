...
import wftech.cavesrevisited.AirOnlyAquifer;
    ...
    */
	...
	@Override
	   public boolean carve(
	      ...
	      Aquifer airAquifer = new AirOnlyAquifer(level);
	                ...
	                if (!isInOcean) {
	                    ...
	                    for (int xIter = minX; xIter < maxX; ++xIter) {
	                        ...
	                        for (int zIter = minZ; zIter < maxZ; ++zIter) {
		        	        	...
		        	        	if(blockX == -1148 && false) {
		        		        	CavesRevisited.LOGGER.info("[CavesRevisited] x=-48, " + blockZ + ", " + xTargetSize + ", " + zTargetSize + ", " + initialX + 
		        		        			", " + zIter + ", " + minBlockZ +
		        		        			", " + initialZ + ", " + diameterMultiplier + ", " + (xTargetSize * xTargetSize) + ", "
		        		        			+ (zTargetSize * zTargetSize) + ", " + (xTargetSize * xTargetSize + zTargetSize * zTargetSize));
		        	        	}
	                            
		        	        	if(blockX == -1147 && false) {
		        		        	CavesRevisited.LOGGER.info("[CavesRevisited] x=-47, " + blockZ + ", " + xTargetSize + ", " + zTargetSize + ", " + initialX + 
		        		        			", " + zIter + ", " + minBlockZ +
		        		        			", " + initialZ + ", " + diameterMultiplier + ", " + (xTargetSize * xTargetSize) + ", "
		        		        			+ (zTargetSize * zTargetSize) + ", " + (xTargetSize * xTargetSize + zTargetSize * zTargetSize));
		        	        	}
	                            ...
	                            for (int yIter = maxY; yIter > minY; --yIter) {
	    	        	        	...
	    	        	        	if(blockX == -1148 && false) {
	    	        		        	CavesRevisited.LOGGER.info("[CavesRevisited] x=-48 2");
	    	        	        	}
	    	        	        	if(blockX == -1147 && false) {
	    	        		        	CavesRevisited.LOGGER.info("[CavesRevisited] x=-47 2");
	    	        	        	}
	                                if (yTargetSize <= -0.7 || 
	                                		xTargetSize * xTargetSize + yTargetSize * yTargetSize + zTargetSize * zTargetSize >= 1.0) continue;

	    	        	        	if(blockX == -1148 && false) {
	    	        		        	CavesRevisited.LOGGER.info("[CavesRevisited] x 3 -> Success @ " + blockX + ", " + yIter + ", " + blockZ);
	    	        	        	}
	                                /*
